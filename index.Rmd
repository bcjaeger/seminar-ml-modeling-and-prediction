...
1. Start by fitting a weak learner to the training data (tree 1)

1. Measure the learner's error

1. Fit a weak learner to the previous learner's error (tree i)

1. Add the current tree's prediction to the ensemble

1. if i = max trees, stop. Otherwise go back to step 2

you can code this yourself!
